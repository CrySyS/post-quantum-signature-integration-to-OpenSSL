...
/* This file is a modified copy of GEMSS_evalMQSnocst8_gf2.c, used for the hybrid 
...
#define GEMSS_NB_EQ_orig (GEMSS_HFEm)
#define GEMSS_NB_EQq_orig (GEMSS_NB_EQ_orig>>3)
#define GEMSS_NB_EQr_orig (GEMSS_NB_EQ_orig&7)
...
#if GEMSS_NB_EQq_orig
    #define GEMSS_NB_EQ (GEMSS_NB_EQq_orig<<3)
#else
    #define GEMSS_NB_EQ GEMSS_NB_EQ_orig
#endif
...
void GEMSS_PREFIX_NAME(GEMSS_evalMQSnocst8_unrolled_quo_gf2)(vecm_gf2 c, cst_vecnv_gf2 m,
                                            cst_mqsnv8_gf2m pk)
{
    UINT xi,xj;
