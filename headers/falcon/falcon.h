...
/*
 * FALCON_ERR_ALLOC is returned when allocation of FALCON structure returns
 * NULL
 */
#define FALCON_ERR_ALLOC       -7

/*
 * FALCON_ERR_PRNG_INIT is returned when intitalizing the prng failed.
 */
#define FALCON_ERR_PRNG_INIT    -8

/*
 * FALCON_ERR_CRPT_BADEXP is returned when the exp variable was given wrong.
 */
#define FALCON_ERR_CRPT_BADEXP  -9

/*
 * FALCON_ERR_FILE_OPEN is returned when the file could not be opened.
 */
#define FALCON_ERR_FILE_OPEN    -10

/*
 * FALCON_ERR_WRITE is returned when writing to file failed.
 */
#define FALCON_ERR_WRITE        -11

/*
 * FALCON_ERR_FILE_READ is returned when the file could not be opened during read.
 */
#define FALCON_ERR_FILE_READ    -12
...
typedef struct falcon_st FALCON;
typedef struct falcon_meth_st FALCON_METHOD;
